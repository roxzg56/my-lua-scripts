...
local function ApplyHardAimbot()
    ...
    pcall(function()
        ...
        entity.AccessoriesVRecoilFactor = 0.9
        entity.AccessoriesHRecoilFactor = 0.9
        entity.GameDeviationFactor = 0.3
        if entity.RecoilInfo then
            entity.RecoilInfo.VerticalRecoilMin = 0.8
            entity.RecoilInfo.VerticalRecoilMax = 0.8
            entity.RecoilInfo.RecoilSpeedVertical = 0.8
            entity.RecoilInfo.RecoilSpeedHorizontal = 0.20
